...
makefile-static-gates:
	$(PYTHON) -m pytest -q tests/test_derived_surfaces.py tests/test_makefile_static_gates.py tests/test_makefile_auto_improve_goal_static_gates.py tests/test_makefile_fast_smoke_static_gates.py tests/test_makefile_learning_static_gates.py tests/test_makefile_public_registry_supply_chain_gates.py tests/test_makefile_release_evidence_static_gates.py tests/test_makefile_release_orchestration_static_gates.py tests/test_makefile_release_smoke_static_gates.py tests/test_makefile_test_execution_summary_gates.py $(PYTEST_CACHE_ISOLATION_FLAGS) $(PYTEST_SERIAL_FLAGS)
