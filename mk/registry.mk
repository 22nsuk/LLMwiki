...
.PHONY: registry-preflight raw-registry-cross-environment-matrix raw-registry-cross-environment-profile-matrices raw-registry-cross-environment-evidence-bundle raw-registry-cross-environment-evidence-bundle-check raw-intake-route-proposal raw-intake-source-quality raw-intake-absorption-closeout raw-registry-export manifest sanitize-runs 
