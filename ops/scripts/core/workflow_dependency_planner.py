...
WORKFLOW_RULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": "Task observation inventory changed; generated-artifact-converge must refresh generated surfaces before final operator summary.",
        "targets": [
            "generated-artifact-converge",
            "release-closeout-summary-conditional",
            "release-evidence-cohort",
    ...
    },
    {
        ...
        "description": "Canonical generated reports changed; refresh generated artifact convergence and seal the batch manifest after tmp cleanup.",
        "targets": [
            "generated-artifact-converge",
            "release-closeout-summary-conditional",
            "release-evidence-cohort",
