...
if __package__ in (None, ""):  # pragma: no cover - direct script fallback
    ...
    from ops.scripts.core.changed_path_minimum_plan_runtime import (
    ...
    from .changed_path_minimum_plan_runtime import (
        build_changed_path_minimum_plan,
        derive_surface_currentness,
        load_test_lane_registry,
    )
...
def build_report(
    ...
    *,
    ...
    test_lane_registry = load_test_lane_registry(resolved_vault)
    derived_surface_currentness = derive_surface_currentness(resolved_vault)
    derived_surface_currentness_paths = [
        str(path) for path in derived_surface_currentness["paths"]
    ]
    changed_path_minimum_plan = build_changed_path_minimum_plan(
        selected_paths,
        test_lane_registry,
