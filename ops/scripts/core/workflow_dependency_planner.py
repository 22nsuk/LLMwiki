...
WORKFLOW_RULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "workflow_id": "release_evidence_closeout",
        "recommended_lane": "release-evidence-closeout",
        "reason_code": "release_runtime_or_schema_contract_changed",
        "description": "Release evidence producers, schemas, or Make orchestration changed; rebuild the ordered release evidence chain before trusting operator summaries.",
        "targets": [
    ...
    },
    {
        ...
        "description": "Report-contract tests or schema samples changed; refresh test-execution evidence, then close the generated report/freshness loop.",
    ...
    },
    {
        ...
        "description": "Root external reports or their manifest changed; refresh report provenance before generated index/freshness and release summaries.",
    ...
    },
    {
        ...
        "recommended_lane": "release-evidence-refresh-fast",
        "reason_code": "task_improvement_observation_inventory_changed",
        "description": "Task observation inventory changed; generated-artifact-index and artifact-freshness must be refreshed before final operator summary.",
        "targets": [
            "release-risk-taxonomy-matrix",
            "generated-artifact-index",
            "artifact-freshness",
    ...
    },
    {
        ...
        "recommended_lane": "artifact-finalization",
        "reason_code": "canonical_report_or_inventory_changed",
        "description": "Canonical generated reports changed; refresh index/freshness and seal the batch manifest after tmp cleanup.",
        "targets": [
            "release-risk-taxonomy-matrix",
            "generated-artifact-index",
            "artifact-freshness",
