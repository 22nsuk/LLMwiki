...
GATE_EFFECT_CLAIM_BLOCKER = "claim_blocker"
...
_GATE_EFFECT_RANK = {
    ...
    GATE_EFFECT_CLAIM_BLOCKER: 2,
    GATE_EFFECT_OPERATOR_REVIEW_REQUIRED: 3,
    GATE_EFFECT_BLOCKS_PROMOTION: 4,
    GATE_EFFECT_BLOCKS_EXECUTION: 5,
}
