...
if __package__ in (None, ""):  # pragma: no cover - direct script fallback
    ...
    from ops.scripts.schema_constants_runtime import ROLLBACK_REHEARSAL_REPORT_SCHEMA_PATH  # noqa: PLC0415
else:
    ...
    from ops.scripts.schema_constants_runtime import ROLLBACK_REHEARSAL_REPORT_SCHEMA_PATH
