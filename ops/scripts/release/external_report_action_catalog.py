...
ACTION_CATALOG: list[dict[str, Any]] = [
    ...
    {
        "action_id": "codex_exec_dependency_preflight_trust_boundary",
        "priority": "P0",
        "theme": "executor dependency preflight trust boundary",
        "patterns": [
            r"dependency preflight.*\.venv/bin/python",
            r"\.venv/bin/python.*trust",
            r"same[- ]root.*workspace.*python",
            r"dependency preflight.*focused\s+test",
            r"codex_exec_dependency_preflight",
        ],
        "evidence_paths": [
        ...
        "recommended_target": "test-executor-runtime",
    },
    {
        "action_id": "bootstrap_dev_install_hardening",
        "priority": "P1",
        "theme": "bootstrap and dev-install hardening",
        "patterns": [
            r"dev-install.*(?:partial|incomplete).*\.venv",
            r"dev-install.*\.venv.*(?:ready|marker|rollback)",
            r"bootstrap dependency check.*incomplete",
            r"bootstrap.*dev dependenc",
            r"bootstrap_preflight",
            r"\.venv\.previous",
        ],
        "evidence_paths": [
            "ops/scripts/core/bootstrap_preflight.py",
        ...
        "recommended_target": "bootstrap-preflight",
    },
    {
        "action_id": "release_manifest_path_classification",
        "priority": "P1",
        "theme": "release manifest path classification",
        "patterns": [
            r"release path predicate.*ambiguous",
            r"release manifest.*path.*classif",
            r"include/exclude/invalid",
            r"path traversal.*inclusion",
            r"release_manifest_(?:includes|excludes)_path",
        ],
        "evidence_paths": [
    ...
    },
    {
        ...
        "recommended_target": "sigstore-bundle SIGSTORE_BUNDLE_REF=<bundle>",
    },
    {
