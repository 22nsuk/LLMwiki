...
| artifact_freshness_stable_contract_debt_advisory | advisory_lifecycle_backlog | does_not_block_clean_lane | not_applicable | not_applicable | review_backlog | artifact freshness stable contract debt |
