...
## Follow-up capture
- Before closing the run, append any reusable automation or repo hygiene follow-up to `runs/run-20260422-auto-improve-decision-record-fallback-retry3-linux-tmp/improvement-observations.json`.
