...
| Auto-promotion evidence | `make release-auto-promotion-ready-check` | `make release-auto-promotion-preflight`, `make release-run-ready`, `make release-auto-promotion-preseal`, `make release-sealed-run-ready`, then `make release-auto-promotion-ready` when unattended promotion is the intended outcome; preflight/preseal pull learning, accepted-risk, gate-attention, and source-tree-coherence blockers ahead of Stage 3, and Stage 3 reuses the sealed operator summary generated by the sealed stage |
